...
- **COMSOL Files:** Numerical simulations and finite element models developed using COMSOL Multiphysics.
- **MATLAB Files:** Analytical computations, data processing scripts, and visualisation tools used in the research.
- **Maple Files:** Symbolic computations and mathematical derivations that support the theoretical framework of the study.
